...
component.created = function () {
    var id = 'pomelo-mysql-view-' + this.instance + '-' + this.database;
    this.$cont = new PomeloComponentContainer('#' + id, this);
    this.$cont.open('/static/mysql/Resource/browse/view-list', { instance: this.instance, database: this.database });
};
